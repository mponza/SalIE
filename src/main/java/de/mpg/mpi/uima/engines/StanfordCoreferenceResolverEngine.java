...
public class StanfordCoreferenceResolverEngine
        extends JCasAnnotator_ImplBase
{
            ...
            throws ResourceInitializationException
    {
        ...
        modelProvider = new ModelProviderBase<Coreferencer>() {
            {
                setContextObject(StanfordCoreferenceResolverEngine.this);
...
/*
 *
 * Like DkPro's StanfordCoreferenceResolver, but it fixes/catches some bugs.
 *
 */
...
//{
//
//    protected Logger logger = LoggerFactory.getLogger(StanfordCoreferenceResolverEngine.class);
//
//    /**
//     * DCoRef parameter: Sieve passes - each class is defined in dcoref/sievepasses/.
//     */
...
//     */
//    public static final String PARAM_POSTPROCESSING = "postprocessing";
//    @ConfigurationParameter(name = PARAM_POSTPROCESSING, defaultValue = "true", mandatory = true)
//    private boolean postprocessing;
//
//    /**
//     * DCoRef parameter: setting singleton predictor
...
//
////                setDefault(ARTIFACT_ID, "de.tudarmstadt.ukp.dkpro.core.stanfordnlp-model-coref-${language}-${variant}");
////                setDefault(LOCATION, "classpath:/de/tudarmstadt/ukp/dkpro/core/stanfordnlp/lib/coref/${language}/${variant}/countries");
////                setDefault(VARIANT, "default");
//
//                setDefault(ARTIFACT_ID, "${groupId}.stanfordnlp-model-coref-${language}-${variant}");
//                setDefault(LOCATION, "classpath:/${package}/lib/coref/${language}/${variant}/countries");
...
//                    // Build the sentence
//                    CoreMap sentence = new CoreLabel();
//                    sentence.set(TreeCoreAnnotations.TreeAnnotation.class, treeCopy);
...
//                            tlp.punctuationWordRejectFilter(), tlp.typedDependencyHeadFinder());
//                    ParserAnnotatorUtils.fillInParseAnnotations(false, true, gsf, sentence,
//                            asList(treeCopy), GrammaticalStructure.Extras.NONE); // bug here
//
//                    // https://github.com/dkpro/dkpro-core/issues/582
//                    SemanticGraph deps = sentence
//                            .get(SemanticGraphCoreAnnotations.CollapsedDependenciesAnnotation.class);
...
//                            SemanticGraphFactory.Mode.COLLAPSED, GrammaticalStructure.Extras.NONE, null, false, true);
//                    sentence.set(SemanticGraphCoreAnnotations.AlternativeDependenciesAnnotation.class,
//                            dependencies);
//
//                    // merge the new CoreLabels with the tree leaves
...
//
//                } catch (Exception e) {
//                    logger.error("Error in Coreference resolution while building coreference resources. " + e.toString());
//                    return;
//                }
//            }
//
...
//            } catch (Exception e) {
//                //throw new AnalysisEngineProcessException(e);
//                String docId = JCasUtil.selectSingle(aJCas, DocumentMetaData.class).getDocumentId();
//                logger.error(String.format("CorefError in document %s", docId));
//                return;
//            }
//
//            for (CorefChain chain : result.values()) {
...
//                    try {
//                        CoreLabel beginLabel = sentences.get(mention.sentNum - 1)
//                                .get(CoreAnnotations.TokensAnnotation.class).get(mention.startIndex - 1);
//                        CoreLabel endLabel = sentences.get(mention.sentNum - 1).get(CoreAnnotations.TokensAnnotation.class)
//                                .get(mention.endIndex - 2);
//
//                        CoreferenceLink link = new CoreferenceLink(aJCas, beginLabel.get(TokenKey.class)
//                                .getBegin(), endLabel.get(TokenKey.class).getEnd());
...
//                        link.addToIndexes();
//                    } catch (Exception e) {
//                        logger.warn("Coref chain broken.");
//                    }
//                }
//            }
//
//        } catch (Exception e) {
//            String docId = JCasUtil.selectSingle(aJCas, DocumentMetaData.class).getDocumentId();
//            logger.error(String.format("StanfordCorefChain Error in document %s", docId));
//        }
//    }
//
//    protected CoreLabel tokenToWord(Token aToken)
